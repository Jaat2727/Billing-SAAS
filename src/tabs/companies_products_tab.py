...
class CompaniesProductsTab(BaseTab):
    ...
    def init_ui(self):
        ...
        self.company_header = self.create_panel_header("Registered Companies", self.controller.show_add_company_dialog, self.controller.handle_bulk_delete_companies)
        ...
        self.product_header = self.create_panel_header("Products", self.controller.show_add_product_dialog, self.controller.handle_bulk_delete_products)
